...
function setup() {
  ...
  //level one (stand2)
  blocks1 = new Block(640,180,30,40);
  blocks2 = new Block(670,180,30,40);
  blocks3 = new Block(700,180,30,40);
  blocks4 = new Block(730,180,30,40);
  blocks5 = new Block(750,180,30,40);
